...
class DeveloperDownloadToLocalCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'interpresso:developer-download';
    ...
    protected function sendGetPaginatedTranslationsRequest(array $params = []): Response
    {
        /** @var string $domain Configured main server URL. */
        $domain = config('interpresso.main_server_domain');
        return Http::post($domain . route('interpresso.api.get-paginated-translations', $params, false), $this->apiKeyParams);
    }
