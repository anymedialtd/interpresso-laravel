<aside id="notifications" data-url="{{ route('interpresso.notifications') }}" data-read-all-url="{{ route('interpresso.notifications.read-all') }}" class="fixed bottom-4 right-4 z-40">
    <button id="notification-toggle" type="button" data-toggle="notification-list" aria-controls="notification-list" aria-expanded="false" class="btn btn-neutral btn-sm"><span>{{ __('interpresso::global.notifications') }} (<span data-count>0</span>)</span></button>
